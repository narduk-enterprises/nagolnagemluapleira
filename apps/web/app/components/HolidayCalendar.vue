    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        <div class="flex items-start gap-3">
          <div
            class="w-12 h-12 rounded-full bg-[var(--color-primary)]/10 flex items-center justify-center shrink-0 personality-transition"
          >
            <UIcon
              :name="index === 0 ? 'i-lucide-sparkles' : 'i-lucide-gift'"
        ...
        <div class="space-y-3 text-sm leading-relaxed">
          ...
          <div
            v-if="holiday.candleRitual"
            class="border-l-2 border-[var(--color-accent)] pl-4 space-y-2"
          >
